...
public class GeneratorCodeServiceImpl implements GeneratorCodeService {
    ...
    public Map<String, String> generatorCodes(@Nonnull final Table table, @Nonnull final List<Column> columns) {
        final GenTable genTable = GenTable.of().init(table, columns, generatorProperties);
    ...
    private static String removeTablePrefix(@Nonnull final Table table, @Nonnull final GeneratorProperties properties) {
        final String tableName = table.getTableName();
        if (!Strings.isNullOrEmpty(tableName)) {
            final boolean autoRemovePrefix = properties.getAutoRemovePrefix();
            final String tablePrefix = properties.getTablePrefix();
    ...
    private static String convertClassName(@Nonnull final Table table, @Nonnull final GeneratorProperties properties) {
        return toCamelCase(removeTablePrefix(table, properties));
    }
    ...
    private static class GenTable implements Serializable {
        ...
        public GenTable init(@Nonnull final Table table, @Nonnull final List<Column> columns, @Nonnull final GeneratorProperties properties) {
            this.packageName = properties.getPackageName();
            this.tableName = table.getTableName();
            this.className = convertClassName(table, properties);
            ...
            this.moduleName = convertModuleName(properties.getPackageName());
    ...
    private static class GenTableColumn implements Serializable {
        ...
        public GenTableColumn init(@Nonnull final GenTable genTable, @Nonnull final Column column) {
            ...
            this.increment = column.getIncrement();
