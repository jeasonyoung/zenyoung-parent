...
public class JwtUtils {
     ...
     * @return Jwt串
     */
    public static <T> String create(@Nonnull final ObjectMapper objMapper, @Nonnull final String id, @Nonnull final T data, @Nullable final Duration maxAge) {
     ...
     */
    public static <T> T parse(@Nonnull final ObjectMapper objMapper, @Nonnull final String token, @Nonnull final Class<T> dataClass) throws TokenException {
        try {
            //解析 claims对象
            ...
            if (Objects.nonNull(claims) && claims.containsKey(PAYLOAD)) {
                ...
                return JsonUtils.fromJson(objMapper, json, dataClass);
            }
