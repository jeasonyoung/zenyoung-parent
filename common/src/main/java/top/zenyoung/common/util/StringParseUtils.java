...
public class StringParseUtils {
     ...
     * @return 目标数据集合
     */
    public static <R extends Serializable> List<R> parse(@Nullable final String strVal, @Nonnull final String sep, @Nonnull final Function<String, R> classParseHandler) {
