...
public class TextValidUtils {
    ...
    public boolean isMatch(@Nonnull final Pattern pattern, @Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isMobile(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isTel(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isIdCard(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isEmail(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isUrl(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isDate(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isTime(@Nullable final CharSequence input) {
     ...
     * @return 是否符合格式
     */
    public boolean isIp(@Nullable final CharSequence input) {
