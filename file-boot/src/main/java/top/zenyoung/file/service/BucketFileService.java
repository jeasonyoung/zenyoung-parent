...
public interface BucketFileService {
     ...
     */
    default FileVO upload(@Nonnull final String key, @Nonnull final File file) throws IOException {
     ...
     * @return 文件字节数据
     */
    default byte[] getFileBytes(@Nonnull final String key) throws IOException {
